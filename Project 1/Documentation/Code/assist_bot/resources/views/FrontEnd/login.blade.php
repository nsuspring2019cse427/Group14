	...
	<main>
		<div class="bg_color_2">
			<div class="container margin_60_35">
				<div id="login-2">
					<h1>Please login to find out your desired forms!</h1>
					<form>
					...
					<p class="text-center link_bright">Do not have an account yet? <a href="sign_up.html"><strong>Register now!</strong></a></p>
				</div>
				<!-- /login -->
			</div>
		</div>
...
<!-- Mirrored from www.ansonika.com/findoctor/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Nov 2018 11:46:21 GMT -->
</html>